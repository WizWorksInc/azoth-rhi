...
namespace sdl_native
{
	...
	/*
	 * The one SDL call that cannot be made without naming Vulkan's types, kept here because native/ is the only place the API boundary check permits them.
	 * Everything else this sample asks of SDL it asks in main.cpp, since the surface interface takes opaque payloads.
	 */
